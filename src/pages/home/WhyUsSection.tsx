  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row justify-center w-full">
        ...
        >
          <h1 className="py-6 text-5xl md:text-6xl p-2 font-bold glow-text">
            Why qrio?
          </h1>
          <span className="text-2xl md:text-4xl font-bold text-gray-100 flex text-center align-middle">CURATING YOUR BRAND !</span>
